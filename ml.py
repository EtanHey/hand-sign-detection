#!/usr/bin/env python3
"""
Hand Sign Detection Pipeline - Everything in one file for easy copying
Supports YOLO, MediaPipe, and custom models for hand sign detection
"""
...
class MLPipeline:
    ...
    def __init__(self, project_name="hand_sign_detection"):
