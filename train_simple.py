#!/usr/bin/env python3
"""
Hand Sign Detection Training - Just run: python train_simple.py

This single file handles everything:
1. Checks your hand sign data
2. Trains a detection/classification model
3. Tests it
...
def setup():
    """One-time setup"""
    print("🚀 Hand Sign Detection Training - Simple Version\n")
